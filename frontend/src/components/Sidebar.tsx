          ...
          {mainNav.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group text-left ${
                  isActive 
        ...
        <div className="flex flex-col gap-1">
          ...
          {secondaryNav.map((item) => {
            ...
            return (
              <button
                key={item.id}
                className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-all duration-200 text-left group"
              >
